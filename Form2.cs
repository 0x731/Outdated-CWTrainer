...
namespace CW_1._0
{
    ...
    public partial class RennysThing : MetroForm
    {
        ...
        public IntPtr XPScaleZM = (IntPtr)0x28;
        public IntPtr GunXPScaleZM = (IntPtr)0x30;
        ...
        public const int PC_SetWeaponID = 0x40; // +(1-5 * 0x40 for WP2 to WP6)
        ...
        private void RennysThing_Load(object sender, EventArgs e)
        {
            ...
            ConsoleOut("Update 1.7.6.8408002");
            ConsoleOut("by Tokyoo");
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            while (true)
            {
                try
                {
                    ...
                    bool checked7 = this.metroCheckBox1.Checked;
                    if (checked7)
                    {
                        cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 47152 + 23780, 100000, 8L, out _);
                        cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 94304 + 23780, 100000, 8L, out _);
                        cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 141456 + 23780, 100000, 8L, out _);
                    }
                    if (checkBox7.Checked)
                    {
                        cwapi.WriteProcessMemory(hProc, PlayerCompPtr + PC_Points, 100000, 8, out _);
                    }
                    bool checked8 = this.metroCheckBox2.Checked;
                    if (checked8)
                    {
                        cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 47152 + 3687, 160, 1L, out _);
                        cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 94304 + 3687, 160, 1L, out _);
                        cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 141456 + 3687, 160, 1L, out _);
                    }
                    else
                    {
                        cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 47152 + 3687, 32, 1L, out _);
                        cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 94304 + 3687, 32, 1L, out _);
                        cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 141456 + 3687, 32, 1L, out _);
                    }
                    bool checked9 = this.metroCheckBox3.Checked;
                    if (checked9)
                    {
                        for (int k = 1; k < 6; k++)
                        {
                            cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 47152 + 5076 + k * 4, 20, 4L, out _);
                            cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 94304 + 5076 + k * 4, 20, 4L, out _);
                            cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 141456 + 5076 + k * 4, 20, 4L, out _);
                        }
                    }
                    // xp modifiers
        ...
        {
            {
                ...
                bool @checked = this.metroRadioButton1.Checked;
                if (@checked)
                {
                    IntPtr intPtr;
                    cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 0 + 176, int.Parse(text), 1L, out _);
                }
                else
                {
                    bool checked2 = this.metroRadioButton2.Checked;
                    if (checked2)
                    {
                        IntPtr intPtr;
                        cwapi.WriteProcessMemory(this.hProc, this.PlayerCompPtr + 0 + 240, int.Parse(text), 1L, out _);
                    }
                }
            }
        }
